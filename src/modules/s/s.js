...
exports.s = async function s(client, message) {
    ...
    if (isMedia && type === 'image') {
        ...
        await client.sendImageAsSticker(from, imageBase64, { author: 'Vrag', pack: 'Pack do Bot', keepScale: true });
        ...
        client.reply(from, "Me mande uma foto ou video. (Utilize !s na legenda ou mencione).", id);
    }
}